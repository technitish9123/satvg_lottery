 ...
 * 1. deposit(uint256 amount) => needs to give allowance from LibToken contract before deposit
...
export const StakingABI = [
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_blockPerYear', type: 'uint256' },
    ],
    name: 'setBlockPerYear',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'address', name: 'chef', type: 'address' }],
    name: 'setChef',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    inputs: [],
    name: 'lib',
    outputs: [{ internalType: 'contractLibToken', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
